...
module.exports = async function (deployer, network, accounts) {
	...
	if (network === 'development' || network == 'gethdev') {
		console.log("reserve deployments")
		...
		await potReserveInstance.setMakerAddresses(mockPotInstance.address, mockDaiInstance.address, mockDaiJoinInstance.address, bankInstance.address)
		...
		await bankInstance.setReserveAddress(potReserveInstance.address)
		const daiPer = await bankInstance.daiPerMyriadWeidai()
		console.log("dai per " + daiPer)
	}
