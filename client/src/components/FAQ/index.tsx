...
const questions = [
	...
	},
	{
		...
		answer: "The Patience Regulation Engine allows for 10 incubation durations worth of blocks to pass before adjusting the difficulty. This is the adjustment cycle. For instance, if the incubation duration is 40 blocks then 400 blocks pass before the duration is either halved or doubled. Suppose in this example that the duration is doubled to 80 blocks. The next adjustment won't happen until at least 800 blocks have passed. Conversely if the duration falls to 20 blocks, the next adjustment will happen after 200 blocks have passed."
	},
	{
