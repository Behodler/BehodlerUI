...
export default function Kharon(props: kharonProps) {
    ...
    ) => walletContextProps.contracts.behodler.Kharon.seed(bellows, behodler, prometheus, pre, weiDaiBank, dai, weidai, scar, cut, donationAddress).send(primaryOptions)
            ...
            <List>
                ...
                <ListItem>
                    <Button
                        variant="contained"
                        color="secondary"
                        onClick={async () => await props.execute(bellows, behodler, prometheus, pre, weiDaiBank, dai, weiDai, scx, cut, donation)}
                    >
                        Execute
                    </Button>
                </ListItem>
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem>
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(toll)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button
                        ...
                        color="secondary"
                        onClick={async () => {
                            let x = await props.execute(token, value)
                            setTollOutput(x.toString())
                        }}
                    >
                        Execute
                    </Button>
                </ListItem>
                <ListItem key="output">{tollOutput}</ListItem>
            </List>
        </Paper>
    )
}
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem>
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(token)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
