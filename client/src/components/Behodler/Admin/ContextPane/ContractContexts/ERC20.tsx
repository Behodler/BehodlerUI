    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="output">{output}</ListItem>
            </List>
        </Paper>
    )
}
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button
                        ...
                        color="secondary"
                        onClick={async () => {
                            const x = await props.execute(address)
                            setOutput(x.toString())
                        }}
                    >
                        Execute
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button
                        ...
                        color="secondary"
                        onClick={async () => {
                            const x = await props.execute(owner, spender)
                            setOutput(x.toString())
                        }}
                    >
                        Execute
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(to, value)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(spender, value)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(from, to, value)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(spender, addedValue)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="button">
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(spender, subtractedValue)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
