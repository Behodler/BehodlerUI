    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem>
                    <Button variant="contained" color="secondary" onClick={async () => await props.setScarcity(scx)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
    ...
    return (
        <Paper>
            ...
            <List>
                ...
                <ListItem key="valid">
                    <Checkbox checked={valid} onChange={handleChangeOfValid} inputProps={{ 'aria-label': 'primary checkbox' }} />
                </ListItem>
                <ListItem>
                    <Button variant="contained" color="secondary" onClick={async () => await props.execute(token, valid)}>
                        Execute
                    </Button>
                </ListItem>
            </List>
