...
function Seed(props: seedProps) {
    ...
    return <Paper>
        ...
        <Button variant="contained" color="secondary" onClick={async () => await props.executeSeed(lachesis, pyroTokenRegistry)}>Execute</Button>
    </Paper>
}
...
function Open (props:openProps){
    ...
    return <Paper>
        ...
        <Button variant="contained" color="secondary" onClick={async () => await props.executeOpen(baseToken,value)}>Execute</Button>
    </Paper>
}