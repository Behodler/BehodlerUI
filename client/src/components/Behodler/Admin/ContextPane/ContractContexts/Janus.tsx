...
export default function Janus(props: janusProps) {
    ...
    const executeTokenToToken = async (input: string, output: string, value: string, minPrice: string, maxPrice: string) => walletContextProps.contracts.behodler.Janus.tokenToToken(input, output, value, minPrice, maxPrice).send(primaryOptions)
    const executeEthToToken = async (output: string, minPrice: string, maxPrice: string) => walletContextProps.contracts.behodler.Janus.ethToToken(output, minPrice, maxPrice).send(primaryOptions)
    const executeTokenToEth = async (input: string, value: string, minPrice: string, maxPrice: string) => walletContextProps.contracts.behodler.Janus.tokenToEth(input, value, minPrice, maxPrice).send(primaryOptions)
...
function Seed(props: seedProps) {
    ...
    return <Paper>
        ...
        <List>
            ...
            <ListItem>
                <Button variant="contained" color="secondary" onClick={async () => await props.execute(scx, weth, behodler)}>Execute</Button>
            </ListItem>
        </List>
    </Paper>
}
...
function TokenToToken(props: tokenToTokenProps) {
    ...
    return <Paper>
        ...
        <List>
            ...
            <ListItem>
                <Button variant="contained" color="secondary" onClick={async () => await props.execute(input, output, value, minPrice, maxPrice)}>Execute</Button>
            </ListItem>
        </List>
    </Paper>
}
...
function EthToToken(props: ethToTokenProps) {
    ...
    return <Paper>
        ...
        <List>
            ...
            <ListItem>
                <Button variant="contained" color="secondary" onClick={async () => await props.execute(output, minPrice, maxPrice)}>Execute</Button>
            </ListItem>
        </List>
    </Paper>
}
...
function TokenToEth(props: tokenToEthProps) {
    ...
    return <Paper>
        ...
        <List>
            ...
            <ListItem>
                <Button variant="contained" color="secondary" onClick={async () => await props.execute(input, value, minPrice, maxPrice)}>Execute</Button>
            </ListItem>
        </List>
    </Paper>
}