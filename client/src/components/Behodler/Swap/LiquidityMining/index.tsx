    ...
    return (
        <div>
            ...
            <Grid container direction="column" justify="center" alignItems="center" spacing={4}>
                ...
                <Grid item>{screen}</Grid>
                {whiteListed ? (
                    <Grid item>
                        <Button onClick={() => setUnstakeClicked(true)} variant="contained" color="secondary">
                            Unstake deposit
                        </Button>
                    </Grid>
                ) : (
...
//             <img src={mining} width={400} className={classes.image} />
//             <a href="https://medium.com/weidaithriftcoin/roadmap-2021-9ee191fa8231" target="_blank">
//                 Road map
//             </a>
//         </Box>
//     );
