...
export default function StepSelection() {
    ...
    useEffect(() => {
        context.contracts.behodler.Behodler2.Morgoth.Migrator.stepCounter().call().then(setCurrentStep)
    })
    switch (currentStep) {
        case 1:
            return <Step1 />
...
function Step1(props: {}) {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            {' '}
            <Grid item>
                <Button onClick={() => setPrepareClicked(true)}>WhiteList and Transfer to Migrator</Button>
            </Grid>
            <Grid item>
                <Button onClick={() => setStep1Clicked(true)}>Step 1</Button>
            </Grid>
        </Grid>
    )
}
...
function Step2(props: {}) {
    ...
    useEffect(() => {
        if (clicked) {
            const array = addresses.split(',').map((a) => a.trim())
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            ...
            <Grid item>
                <Button onClick={() => setClicked(true)}>Step 2</Button>
            </Grid>
        </Grid>
    )
    //execute
...
function Step3(props: {}) {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            <Grid item>
                <Button onClick={() => setClicked(true)}>Step 3</Button>
            </Grid>
        </Grid>
    )
    //execute
...
function Step4(props: {}) {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            ...
            <Grid item>
                <Button onClick={() => setClicked(true)}>Step 4</Button>
            </Grid>
        </Grid>
    )
    //execute
...
function Step5(props: {}) {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            ...
            <Grid item>
                <Button onClick={() => setClicked(true)}>Step 5</Button>
            </Grid>
        </Grid>
    )
    //execute
...
function Step6(props: {}) {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            ...
            <Grid item>
                <Button onClick={() => setClicked(true)}>Step 6</Button>
            </Grid>
        </Grid>
    )
    //execute
...
function Step7(props: {}) {
    ...
    return (
        <Grid container direction="row" justify="center" alignItems="center" spacing={2}>
            <Grid item>
                <Button onClick={() => setClicked(true)}>Step 7</Button>
            </Grid>
        </Grid>
    )
    //execute
