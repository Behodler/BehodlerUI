    ...
    return (hidden ? <div></div> : <Toolbar>
        ...
        >
            <Grid item className={classes.metagrid}>
                Please note: Metmask appears to be overestimating gas. A fix is in progress. If the estimate is comparable to Uniswap, then it is overestimated. Please do not worry when confirming.
                </Grid>
            <Grid item>
                <IconButton onClick={() => setHideClicked(true)} color="secondary"><CloseIcon /></IconButton>
            </Grid>
