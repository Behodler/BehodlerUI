...
const weiDaiDetail: DetailProps = {
	...
	content: "WEIDAI IS AN ERC20 TOKEN THAT WRAPS THE DAI STABLE COIN. WEIDAI REDEEM RATE IS THE AMOUNT OF DAI THAT 1 WEIDAI CAN BE REDEEMED FOR. THIS NUMBER INCREASES WITH REGULAR USE BUT IT CANNOT DROP.",
	linkText: "Learn more",
...
const penaltyReductionPeriodDetail: DetailProps = {
	...
	content: "AFTER WEIDAI IS CREATED IT HAS TO INCUBATE BEFORE BEING CLAIMED. IF YOU CLAIM NEWLY CREATED WEIDAI BEFORE THE INCUBATION PERIOD ENDS, A PENALTY TAX IS LEVIED. THE PENALTY FALLS BY 5 PERCENTAGE POINTS EVERY PENALTY REDUCTION PERIOD WHICH IS MEASURED IN ETHEREUM BLOCKS. FOR EXAMPLE, SUPPOSE THE PENALTY REDUCTION PERIOD IS 4 AND YOU PURCHASE 200 WEIDAI. AFTER 4 BLOCKS HAVE PASSED, IF YOU ATTEMPT TO CLAIM YOUR WEIDAI, YOU'LL ONLY RECEIVE 10 SINCE THE PENALTY WILL BE 95%. IF YOU WITHDRAW AFTER 20 BLOCKS, THE PENALTY WOULD HAVE FALLEN TO 75% WHICH MEANS YOU'LL RECEIVE 50 WEIDAI.",
	linkText: "Learn more",
	linkURL: "https://medium.com/"
}
